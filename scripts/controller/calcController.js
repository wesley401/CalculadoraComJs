class CalcController {
    ...
    getLastItem(isOperator = true) {
        ...
        for (let i = this._operation.length - 1; i >= 0; i--) {
            if (this.isOparator(this._operation[i]) == isOperator) {
    ...
    addOperation(value) {
        ...
        if (isNaN(this.getLastOparation())) {
            ...
            if (this.isOparator(value)) {
                ...
                this.setLastOparation(newValue);
    ...
    addDot() {
        ...
        if (this.isOparator(lastOperation) || !lastOperation) {
            this.pushOperation('0.');
        } else {
            this.setLastOparation(lastOperation.toString() + '.');
        }
        this.setLastNumberToDisplay();
    ...
    initiButtonsEvent() {
        ...
        buttons.forEach((btn) => {
            ...
            this.addEventListenerAll(btn, "mouserover mouseup mousedown", e => {
